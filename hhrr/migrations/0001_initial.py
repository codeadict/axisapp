    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_type', models.IntegerField(default=2, verbose_name='Identification type', choices=[(0, 'R.U.C.'), (1, 'Passport'), (2, 'National ID Card')])),
                ('identification', models.CharField(max_length=20, verbose_name='ID number')),
                ('photo', models.ImageField(upload_to=b'photos/employee/', null=True, verbose_name='Image', blank=True)),
                ...
                ('nationality', django_countries.fields.CountryField(default=b'EC', max_length=2, verbose_name='Nationality')),
                ...
                ('handicapped', models.BooleanField(default=False, verbose_name='Is handicapped?')),
                ('handicap_percent', base.fields.PercentageField(default=0, verbose_name='Handicap percent', max_digits=6, decimal_places=3, blank=True)),
                ('handicap_type', models.CharField(max_length=255, verbose_name='Handicap type', blank=True)),
                ('handicap_card_number', models.CharField(max_length=255, verbose_name='Handicap card number', blank=True)),
                ...
                ('skype', models.CharField(max_length=255, verbose_name='Skype user', blank=True)),
                ...
                ('status', models.IntegerField(default=1, verbose_name='Status', choices=[(0, 'Inactive'), (1, 'Active'), (3, 'Settled')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(related_name=b'employment_history', to='hhrr.Employee')),
            ],
            options={
                'ordering': ['date_out'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.ForeignKey(verbose_name='Department Manager', blank=True, to='hhrr.Employee', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(related_name=b'family_dependants', to='hhrr.Employee')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(related_name=b'languages', to='hhrr.Employee')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.AddField(
            model_name='education',
            name='employee',
            field=models.ForeignKey(related_name=b'education_records', to='hhrr.Employee'),
            preserve_default=True,
        ),
    ]
