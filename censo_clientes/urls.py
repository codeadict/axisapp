...
urlpatterns = patterns('',
                       ...
                       url(r'^poligonos.geojson$',
                           GeoJSONLayerView.as_view(model=Area, geometry_field='poligono', properties=(
                               ['nombre', 'id']
                           )), name='poligonos_data'),
                       url(r'^distributions.geojson$',
                           GeoJSONLayerView.as_view(model=PresalesDistribution, geometry_field='polygon', properties=(
                               ['name', 'id']
                           )), name='distribution_data'),
                       url(r'^clientes.geojson$',
                           GeoJSONLayerView.as_view(model=Cliente, geometry_field='coordenadas', properties=(
                               ['popupContent', 'id', ]
                           )), name='clients_data'),
