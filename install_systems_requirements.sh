...
APT_REPOS_FILE=$REQUIREMENTS_DIR/"debian-based/apt-repos.txt"
APT_PKGS_FILE=$REQUIREMENTS_DIR/"debian-based/apt-packages.txt"
...
case `uname -s` in
    [Ll]inux)
        ...
        case $distro in
            ...
            squeeze|wheezy|jessie|maya|lisa|olivia|nadia|natty|oneiric|precise|quantal|raring|luna)
